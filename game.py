...
class Game:
    def __init__(self, skin_path):
        ...
        self.dico_message = { "Pingu écolo! - assets/gateau dechet.png": "Oh non ! Pingu a glissé sur un gâteau !", "Pingu écolo! - assets/trou banquise.png": "Aïe ! Pingu est tombé dans un trou !", "Pingu écolo! - assets/bouteille dechet.png": "Pingu a trébuché sur une bouteille !", "Pingu écolo! - assets/compote dechet.png": "Pingu a glissé sur une compote !" }
        # CALAMAR = 200×200
